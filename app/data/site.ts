export const siteData = {
  ...
  contact: {
    ...
    info: [
      { label: "Headquarters", value: "18 Raffles Quay, #22-00, Singapore 048582" },
      { label: "Trade desk", value: "+65 6823 4400" },
      { label: "Email", value: "trade@hevinet.com" },
    ],
    form: {
